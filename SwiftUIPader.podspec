Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  This framework provides a horizontal pager build with native SwiftUI views. Views are recycled, so you don't have to worry about memory issues. It's very easy to use and lets you customize it. For example, you can change the aspect ratio of the page displayed, the spacing between pages or you can make it interactive.
                   DESC
